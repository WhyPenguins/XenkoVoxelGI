...
namespace Xenko.Rendering
{
    ...
    {
        internal partial class XenkoLightingVXGI  : IShaderMixinBuilder
        {
            ...
            {
                ShaderMixinManager.Register("XenkoLightingVXGI", new XenkoLightingVXGI());
            }
        }
    }
    internal static partial class ShaderMixins
    {
        internal partial class XenkoForwardShadingEffectVXGI  : IShaderMixinBuilder
        {
            public void Generate(ShaderMixinSource mixin, ShaderMixinContext context)
            {
            ...
            {
                ShaderMixinManager.Register("XenkoForwardShadingEffectVXGI", new XenkoForwardShadingEffectVXGI());
            }
        }
    }
}
